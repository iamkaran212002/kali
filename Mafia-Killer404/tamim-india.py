...
#---------------------------------------
# Source File : tamim-india.py
# Time : Sun Feb 14 08:32:10 2021
#---------------------------------------
#!/usr/bin/python2
#coding=utf-8
...
\033[1;96m             ░█░ █▀█ █░▀░█ █ █░▀░█
 ...
 \033[1;91m    NAME----         TJ TAMIM
 \033[1;92m    WHATS APP---- +8801904155851
 \033[1;93m    NOTE----USE SIM 6GB RAM MOBILE
 \033[1;96m    COMMAND TYPE----NO LOGIN (INDIA)
...
def action():
    ...
    if peak =='':
        ...
        os.system("clear")
        print logo2
        print "Enter any india  Mobile sim code "+'\n'
    ...
    jalan ("\033[1;95mTJ TAMIM total 5 password will clone... all digit , last 7 digit, india123, 000786, 786786 password Start Cracking...")
